...
export default function TableCustom({ movie, handleOpenpopup, handleOpenpopupDelete, handleOpenpopupEdit }) {
						...
						<TableRow key={row.name}>
							<TableCell component='th' scope='row'>
								<span className='d-flex justify-content-between'>
                                    <span onClick={()=> handleOpenpopupEdit(row)} className={`${classes.btnAdd}`}><EditIcon /></span>
                                    <span onClick={()=> handleOpenpopupDelete(row.id)} className={`${classes.btnAdd}`}><DeleteOutlineIcon /></span>
								</span>
							</TableCell>
